<template>
  <v-app id="home">
    <component :is="isSmallScreen ? 'NavMenu' : 'NavBar'"/>
    <v-container fluid>
      <div class = "head">
        <v-row>
          <v-col cols="6" sm="0">
        ...
        <div>
          ...
          <div class="skills">
            ...
            <v-row>
              <v-col cols="3">
                <div>
                  <v-img src="../assets/python.png" contain max-height="60px"></v-img>
                </div>
              </v-col>
              <v-col cols="3">
                <div>
                  <v-img src="../assets/java.png" contain max-height="60px"></v-img>
                </div>
              </v-col>
              <v-col cols="3">
                <div>
                  <v-img src="../assets/c.png" contain max-height="60px"></v-img>
                </div>
              </v-col>
              <v-col cols="3">
                <div>
                  <v-img src="../assets/unity.png" contain max-height="60px"></v-img>
                </div>
              </v-col>
           </v-row>
          </div>
      ...
      <div id = "experiences" class = "experiences">
        <h1 class="text-blue" style="font-size:48px;">Experiences</h1>
        <v-card elevation="0">
      ...
      <div class = "contact" id = "contact">
        <v-row>
          <v-col :cols="isSmallScreenContact ? 12 : 5" class="info">
            <h1 class="text-blue" style = "margin-bottom: 2vh">Contact</h1>
            <ul style= "list-style-type: none">
              <li><a href="https://github.com/ThomasChen0717" target = "_blank">Github </a></li> <br />
              <li><a href="" target = "_blank">Linkdin </a></li>  <br />
...
export default defineComponent({
  ...
  methods:{
    handleScreenResize(){
      ...
      this.isSmallScreenContact = window.innerWidth <= 950;
    },
    scroll(refName){
